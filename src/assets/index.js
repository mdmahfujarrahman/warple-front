...
import resionButtom from "./resionButtom.png";

// point
import ponitOne from "./points/point1.png";
import ponitTwo from "./points/point2.png";
...
export const warplePoint = {
    ponitOne,
    ponitTwo,
    ponitThree,
};
export const warpleUse = {
    step1,
    email,
    dollor,
    document,
